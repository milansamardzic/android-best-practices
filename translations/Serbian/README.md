...
Lekcije ucite sa Android developers na Futurice](http://www.futurice.com).
Izbjegavajte izmišljanje tople vode, pratite ova uputstva i najbolje prakse.
Ako ste zainteresovani za iOS ili Windwos Phone development, provjerite naša uputstva na [**iOS Good Practices**](https://github.com/futurice/ios-good-practices) i [**Windows App Development Best Practices**](https://github.com/futurice/windows-app-development-best-practices).

[![Android Arsenal](https://img.shields.io/badge/Android%20Arsenal-android--best--practices-brightgreen.svg?style=flat)](https://android-arsenal.com/details/1/1091)

## Sadržaj

#### Koristite Gradle i to je ujedno preporučena projekat struktura
#### Šifre i ostale osjetljive podatke stavite u gradle.properties
#### Ne pravite se pametni, ne pišite vlastite HTTP klijentem, koristite Volley or OkHttp biblioteke
#### Koristite Jackson biblioteku da partisate JSON podatke
#### Izbjegavajte Guava i koristite par biblioteka zbog *65k method limit*
#### Koristite Fragments da prikažete Korisnički interfejs (UI)
#### Koristite Activities samo za menadžovanje i upravljanje fragmentima
#### Layout XMLs su takođe kod, oragnizujte ih dobro
#### Koristite stilove da izbjegnete dupilranje atributa u layout XMLs
#### Koristite više stilova da izbjegnete jedan veliki, postaje beskoristan
#### Držite colors.xml kratkim, samo definišite palete
#### Takođe dimens.xml čuvajte kratkim, definišite generične konstante
#### Ne pravite duboku/veliku hijerarhiju ViewGroups
#### Izbjegavajte client-side procesovanje za WebViews, i budite oprezni na curenja i bugove
#### Koristite Robolectric za unit tests, Robotium za konektovanje (UI) testova
#### Koristite Genymotion kao svoj emulator
#### Uvijek koristite ProGuard or DexGuard
...
Postavite svoj [Android SDK](https://developer.android.com/sdk/installing/index.html?pkg=tools) negje u home direktorijum ili u neki drugi folder koji je u nezavisnoj vezi sa aplikacijom. Neki IDEs uključuju SDK kada se instaliraju, i mogu biti u istom direktoriju kao i IDE. Ovo može biti problem u slučaju updatejta ili reinstalacije. Takođe izbjegavajte stavljanje SDKa u neki sistemski folder koji može zahtijevati administratorske dozvole. Ukoliko postavite SDK u neki takav folder vaš IDE će morati da ima administratroste dozvole i da bude pokrenut kao administrator da bi mogao pristupiti SDK direktriju.

### Build system

Vaša standardna opcija treba da bude [Gradle](http://tools.android.com/tech-docs/new-build-system). 
Ant je mnogo više limitiran. Sa Gradle-om, je jednostavnije da:

- Bildate različite okuse ili varijate vaše aplikacije
- Napravite jednostavne skripte kao taskove
- Menađerujete i preuzmete biblioteke i sl.
- Prilagođavanje keystores
- i još mnogo toga

Android's Gradle plugin je napravljen od strane Googla i predstavlja novi standard.

### Struktura projekta

Popularne su 2 opcije: stara Ant i Eclipse ADT projekt struktura, i nova Gradle & Android Studio projekat struktura. Preporučujemo novu strukturu.
Ako vaša aplikacija i vi koristite startu strukturu počnite sa razmatranjem da pređete na novu.
